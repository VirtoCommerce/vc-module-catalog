...
{
    public class CategoryDocumentChangesProvider2 : CategoryDocumentChangesProvider
    {
        public CategoryDocumentChangesProvider2(Func<ICatalogRepository> catalogRepositoryFactory, IChangeLogSearchService changeLogSearchService) : base(catalogRepositoryFactory, changeLogSearchService)
        {
        }
