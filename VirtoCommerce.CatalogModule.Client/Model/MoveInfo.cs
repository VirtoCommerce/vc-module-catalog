...
namespace VirtoCommerce.CatalogModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MoveInfo :  IEquatable<MoveInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MoveInfo);
        }

        /// <summary>
        /// Returns true if MoveInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of MoveInfo to be compared</param>
        /// <returns>Boolean</returns>
