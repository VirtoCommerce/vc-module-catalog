...
namespace VirtoCommerce.CatalogModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsvExportInfo :  IEquatable<CsvExportInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CsvExportInfo);
        }

        /// <summary>
        /// Returns true if CsvExportInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CsvExportInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsvExportInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
