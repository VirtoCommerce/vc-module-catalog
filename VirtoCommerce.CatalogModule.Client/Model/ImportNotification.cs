...
namespace VirtoCommerce.CatalogModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportNotification :  IEquatable<ImportNotification>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportNotification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ImportNotification);
        }

        /// <summary>
        /// Returns true if ImportNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ImportNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
