...
namespace VirtoCommerce.CatalogModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CsvImportInfo :  IEquatable<CsvImportInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CsvImportInfo);
        }

        /// <summary>
        /// Returns true if CsvImportInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of CsvImportInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsvImportInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
