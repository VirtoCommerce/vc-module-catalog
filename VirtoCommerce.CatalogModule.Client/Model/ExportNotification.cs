...
namespace VirtoCommerce.CatalogModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExportNotification :  IEquatable<ExportNotification>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportNotification {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExportNotification);
        }

        /// <summary>
        /// Returns true if ExportNotification instances are equal
        /// </summary>
        /// <param name="other">Instance of ExportNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportNotification other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
