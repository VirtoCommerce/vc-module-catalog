...
{
    /// <summary>
    /// CsvProductPropertyMap
    /// </summary>
    [DataContract]
    public partial class CsvProductPropertyMap :  IEquatable<CsvProductPropertyMap>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CsvProductPropertyMap {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CsvProductPropertyMap);
        }

        /// <summary>
        /// Returns true if CsvProductPropertyMap instances are equal
        /// </summary>
        /// <param name="other">Instance of CsvProductPropertyMap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsvProductPropertyMap other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
