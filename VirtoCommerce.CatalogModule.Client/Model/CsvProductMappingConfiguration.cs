...
{
    /// <summary>
    /// CsvProductMappingConfiguration
    /// </summary>
    [DataContract]
    public partial class CsvProductMappingConfiguration :  IEquatable<CsvProductMappingConfiguration>
    {
        /// <summary>
        /// Gets or Sets ETag
        /// </summary>
        ...
        public List<CsvProductPropertyMap> PropertyMaps { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CsvProductMappingConfiguration {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CsvProductMappingConfiguration);
        }

        /// <summary>
        /// Returns true if CsvProductMappingConfiguration instances are equal
        /// </summary>
        /// <param name="other">Instance of CsvProductMappingConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CsvProductMappingConfiguration other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
