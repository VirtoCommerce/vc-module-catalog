...
namespace VirtoCommerce.CatalogModule.Test
{
    ...
    public class TermFilterBuilderTests : BrowseFiltersTestBase
    {
        ...
        public async Task TestPriceTerms(string terms, string currency, string pricelists, string expectedPermanentFilters, string expectedRemovableFilters)
        {
            var criteria = new ProductIndexedSearchCriteria
            {
                Terms = terms?.Split(';'),
        ...
        public async Task TestTagsTerms(string terms, string currency, string pricelists, string expectedPermanentFilters, string expectedRemovableFilters)
        {
            var criteria = new ProductIndexedSearchCriteria
            {
                Terms = terms?.Split(';'),
