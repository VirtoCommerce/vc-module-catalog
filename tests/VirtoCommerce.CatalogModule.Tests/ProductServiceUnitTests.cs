...
namespace VirtoCommerce.CatalogModule.Tests
{
    public class ProductServiceUnitTests
    {
        ...
        private ProductService GetProductServiceWithPlatformMemoryCache()
        {
            ...
            return GetProductService(platformMemoryCache, _repositoryMock.Object);
        }

        private ProductService GetProductService(IPlatformMemoryCache platformMemoryCache, ICatalogRepository catalogRepository)
        {
            _hasPropertyValidatorMock
                .Setup(x => x.ValidateAsync(It.IsAny<ValidationContext<IHasProperties>>(), default))
                .ReturnsAsync(new ValidationResult());

            return new ProductService(() => catalogRepository,
                platformMemoryCache,
