...
namespace VirtoCommerce.CatalogModule.Data.Search.Indexing
{
    public class CategoryDocumentBuilder : CatalogDocumentBuilder, IIndexDocumentBuilder
    {
        ...
        {
            return _categoryService.GetByIdsAsync(categoryIds.ToArray(), (CategoryResponseGroup.WithProperties | CategoryResponseGroup.WithOutlines | CategoryResponseGroup.WithImages | CategoryResponseGroup.WithSeo | CategoryResponseGroup.WithLinks | CategoryResponseGroup.WithReviews).ToString());
        }
