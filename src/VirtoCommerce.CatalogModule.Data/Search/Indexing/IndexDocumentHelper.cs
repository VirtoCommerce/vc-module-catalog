...
namespace VirtoCommerce.CatalogModule.Data.Search.Indexing
{
    public static class IndexDocumentHelper
    {
        ...
        {
            document.Add(new IndexDocumentField(ObjectFieldName, value, IndexDocumentFieldValueType.Complex) { IsRetrievable = true, IsFilterable = false, IsSearchable = false });
        }
