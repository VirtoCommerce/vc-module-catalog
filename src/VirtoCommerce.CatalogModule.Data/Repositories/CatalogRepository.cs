...
namespace VirtoCommerce.CatalogModule.Data.Repositories
{
    public class CatalogRepository : DbContextRepositoryBase<CatalogDbContext>, ICatalogRepository
    {
        ...
        public virtual async Task<IEnumerable<CatalogEntity>> GetCatalogsByIdsAsync(IEnumerable<string> ids, string responseGroup = null)
        {
            ...
            if (!ids.IsNullOrEmpty())
            {
                ...
                if (result.Any())
                {
                    ...
                    await PropertyValues.Include(x => x.DictionaryItem.DictionaryItemValues)
                                                           .Where(x => ids.Contains(x.CatalogId) && x.CategoryId == null).LoadAsync();
                    var catalogPropertiesIds = await Properties.Where(x => ids.Contains(x.CatalogId) && x.CategoryId == null)
                        .Select(x => x.Id)
                        .ToArrayAsync();
        ...
        public virtual async Task<IEnumerable<CategoryEntity>> GetCategoriesByIdsAsync(IEnumerable<string> categoriesIds, string responseGroup)
        {
        ...
        public virtual async Task<IEnumerable<ItemEntity>> GetItemByIdsAsync(IEnumerable<string> itemIds, string responseGroup = null)
        {
        ...
        public virtual async Task<IEnumerable<PropertyEntity>> GetPropertiesByIdsAsync(IEnumerable<string> propIds, bool loadDictValues = false)
        {
        ...
        /// <returns></returns>
        public virtual async Task<IEnumerable<PropertyEntity>> GetAllCatalogPropertiesAsync(string catalogId)
        {
            var result = Enumerable.Empty<PropertyEntity>();
        ...
        public virtual async Task<IEnumerable<PropertyDictionaryItemEntity>> GetPropertyDictionaryItemsByIdsAsync(IEnumerable<string> dictItemIds)
        {
        ...
        public virtual async Task<IEnumerable<AssociationEntity>> GetAssociationsByIdsAsync(IEnumerable<string> associationIds)
        {
        ...
        public virtual async Task<IEnumerable<string>> GetAllSeoDuplicatesIdsAsync()
        {
        ...
        public virtual async Task<IEnumerable<string>> GetAllChildrenCategoriesIdsAsync(IEnumerable<string> categoryIds)
        {
            string[] result = null;
        ...
        public virtual async Task RemoveItemsAsync(IEnumerable<string> itemIds)
        {
            if (!itemIds.IsNullOrEmpty())
            {
                var itemIdsCount = itemIds.Count();
                var skip = 0;
                do
                {
                    const string commandTemplate = @"
                ...
                while (skip < itemIdsCount);

                //TODO: Notify about removed entities by event or trigger
            }
        }

        public virtual async Task RemoveCategoriesAsync(IEnumerable<string> ids)
        {
            if (!ids.IsNullOrEmpty())
            {
        ...
        public virtual async Task RemoveCatalogsAsync(IEnumerable<string> ids)
        {
            if (!ids.IsNullOrEmpty())
            {
