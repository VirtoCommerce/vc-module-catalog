...
{
    public class CategoryEditorialReviewEntity : AuditableEntity
    {
        ...
        public virtual CategoryEditorialReview ToModel(CategoryEditorialReview review)
        {
            if (review == null)
        ...
        public virtual CategoryEditorialReviewEntity FromModel(CategoryEditorialReview review, PrimaryKeyResolvingMap pkMap)
        {
            if (review == null)
                throw new ArgumentNullException(nameof(review));
        ...
        public virtual void Patch(CategoryEditorialReviewEntity target)
        {
