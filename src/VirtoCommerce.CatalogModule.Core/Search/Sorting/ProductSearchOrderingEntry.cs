...
/// <summary>
/// The persisted shape of a single ordering in the store-level setting (JSON array). It is intentionally a
...
/// </summary>
public class ProductSearchOrderingEntry
{
    ...
    /// <summary>True when this entry is an admin-authored ordering with no backing code resolver.</summary>
