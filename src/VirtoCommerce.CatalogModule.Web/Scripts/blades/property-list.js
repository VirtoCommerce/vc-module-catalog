angular.module('virtoCommerce.catalogModule')
    .controller('virtoCommerce.catalogModule.propertyListController',
        ['$scope', 'virtoCommerce.catalogModule.properties', 'platformWebApp.bladeNavigationService', 'virtoCommerce.catalogModule.propDictItems', '$localStorage', 'platformWebApp.authService', 'virtoCommerce.catalogModule.measures',
            function ($scope, properties, bladeNavigationService, propDictItems, $localStorage, authService, measures) {
