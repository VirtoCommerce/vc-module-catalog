angular.module('virtoCommerce.catalogModule')
    .controller('virtoCommerce.catalogModule.propertyGroupListController',
        ['$scope', 'platformWebApp.uiGridHelper', 'platformWebApp.bladeNavigationService', 'virtoCommerce.catalogModule.propertyGroups', 'platformWebApp.dialogService',
        function ($scope, uiGridHelper, bladeNavigationService, propertyGroups, dialogService) {
