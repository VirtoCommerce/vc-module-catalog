...
namespace VirtoCommerce.CatalogModule.Web
{
    public class Module : IModule, IHasConfiguration, IExportSupport, IImportSupport
    {
        ...
        public void Initialize(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddTransient<ICatalogCrudService, CatalogService>();
            ...
            serviceCollection.AddTransient<ICategoryCrudService, CategoryService>();
            ...
            serviceCollection.AddTransient<IProductCrudService, ItemService>();
        ...
        public void PostInitialize(IApplicationBuilder appBuilder)
        {
            ...
            inProcessBus.RegisterHandler<CategoryChangedEvent>(async (message, token) => await appBuilder.ApplicationServices.GetService<TrackHierarchyChangesEventHandler>().Handle(message));
